  ...
  return (
    <div className="px-4 py-6 sm:px-0">
      <div className="flex justify-between items-center mb-6">
        <div>
          <Link href={`/patients/${params.patientId}`} className="text-sm text-gray-500 hover:text-gray-900">&larr; Back to Patient</Link>
          <h1 className="text-2xl font-bold text-gray-900 mt-2">Clinical Notes</h1>
        </div>
        <Link
          href={`/patients/${params.patientId}/notes/new`}
